...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Video } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-950 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <h1 className="text-3xl font-bold text-center text-white mb-2">Creator Sign Up</h1>
            ...
            <div className="space-y-3 text-sm text-center">
              <p className="text-gray-400">
                Are you a brand?{' '}
                <Link href="/register/brand" className="text-purple-400 hover:text-purple-300 font-semibold">
                  Sign up as brand
                </Link>
              </p>
              <p className="text-gray-400">
                Already have an account?{' '}
                <Link href="/login/creator" className="text-purple-400 hover:text-purple-300 font-semibold">
                  Sign in
                </Link>
              </p>
            </div>
