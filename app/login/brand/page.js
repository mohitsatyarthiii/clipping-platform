...
import { Mail, Lock, ArrowRight, Eye, EyeOff, Building2 } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-950 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <h1 className="text-3xl font-bold text-center text-white mb-2">Brand Sign In</h1>
            <p className="text-center text-gray-400 mb-8">Manage your campaigns and creators</p>
            ...
            <div className="space-y-3 text-sm text-center">
              <p className="text-gray-400">
                ...
                <Link href="/register/brand" className="text-brand-400 hover:text-brand-300 font-semibold">
                  Sign up as brand
                </Link>
              </p>
              <p className="text-gray-400">
                Are you a creator?{' '}
                <Link href="/login/creator" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                  Creator sign in
                </Link>
              </p>
            </div>
